...
class TodoInput extends React.Component {
    ...
    validateText(text) {
        ...
        if (text.match(/[^;,"()@!.\-: a-zA-Z0-9]/g)) {
            errorList.push('Only english letters, spaces, number, and the following characters are allowed: colons, commas, semicolons, round brackets, exclamation marks, dots, @ signs, dashes, and double quotes.');
        }
