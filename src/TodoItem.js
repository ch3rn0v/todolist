...
class TodoItem extends React.Component {
  constructor(props) {
    ...
    this.decreaseOpacityDuringRemoval = this.decreaseOpacityDuringRemoval.bind(
      this
    );
  ...
  onCancelRemoval() {
    ...
    this.setState({
      removingInProgress: false,
      opacity: this.state.checked
        ? ITEM_CHECKED_OPACITY
        : ITEM_UNCHECKED_OPACITY
    });
  }
  ...
  render() {
    ...
    return (
      <li className="todo-item">
        ...
        <RemoveItemButton
          onClick={
            removingInProgress ? this.onCancelRemoval : this.onItemRemove
          }
          isRemovingInProgress={removingInProgress}
        />
      </li>
    );
  }
